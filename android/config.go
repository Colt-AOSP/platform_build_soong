...
func (c *deviceConfig) BoardUsesQTIHardware() bool {
	return Bool(c.config.ProductVariables.Colt.BoardUsesQTIHardware)
}

func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.ProductVariables.Colt.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.ProductVariables.Colt.QTIDisplayPath)
}

func (c *deviceConfig) QTIMediaPath() string {
	return String(c.config.ProductVariables.Colt.QTIMediaPath)
}
